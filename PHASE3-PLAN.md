...
| **W1.5** ✅ | 群組配方（2026-07-16 完成） | FR-14.5～14.8 | RCPG | ≈ 3 |
| **W2** ✅ | 豆子生命週期＋風味輪（2026-07-16 完成） | FR-15、FR-18、FR-21 | INV、COST、WHL | ≈ 5 |
| **W3** ✅ | 分析到行動（2026-07-17 完成） | FR-16、FR-17、FR-19、FR-20 | WIN、CMP、INS、RVW | ≈ 9 |
| **W4** ✅ | 照片與分享（2026-07-16 全數完成，含 SHARE-3 配方卡圖片與列表縮圖） | FR-22、FR-9 | PHOTO、SHARE | ≈ 8 |
